...
const ProductDetailPage = () => {
  ...
  const getMacbookImage = (product: Product, prod: ProductDetails) => {
    return require(`../../assets/images/mbp${product.size
      .toLowerCase()
      .replace("-inch", "")}-${prod.color.toLowerCase().replace(" ", "")}.jpg`);
  };

  return (
    <>
      <div className={`fixed desktop:block`}>
            ...
            <div className="container grid desktop:grid-cols-2">
              ...
              <div className="flex justify-end">
                <div className="flex items-start flex-row">
                  <div className="flex-initial">
                    <p className="text-2xl font-medium text-end tracking-tight">
                      RM{" "}
                  ...
                  <div className="flex self-start">
                    <button
                      ...
                      className="bg-blue-600 text-white text-sm px-4 py-2 mx-5 w-full rounded-lg"
                    >
                      Add to Bag
                    </button>
                  </div>
	...
	L8.158,44.714V2h31.75V44.714z"
      ...
      <div className="product-details">Hi</div>

      <div className="desktop:gap-8 gap-4 desktop:p-6 p-4 desktop:mx-64 wide_desktop:mx-96 product-details">
      ...
      <div className="container mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold mb-4">{product.specs[0]}</h1>
        {/* <img src={product.imageUrl} alt="MacBook" className="mb-4" /> */}
        ...
        <button
          onClick={() => console.log("Purchase functionality here")}
      ...
      <div className="container mx-auto py-6">
        <div className="flex space-x-6">
          <img
            src="path/to/macbook-image.png"
            alt="MacBook Pro"
            className="w-1/2"
          />
          <div>
            <h1 className="text-3xl font-bold">MacBook Pro 14-inch</h1>
            <p className="mt-4">
              Description of the MacBook Pro 14-inch model...
            </p>
            <p className="mt-4 font-bold">Price: RM 7,499.00</p>
